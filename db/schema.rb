...
ActiveRecord::Schema[7.0].define(version: 2026_07_01_103430) do
  ...
  create_table "photos", force: :cascade do |t|
    ...
    t.index ["published", "featured", "taken_on"], name: "index_photos_on_published_and_featured_and_taken_on"
